...
if [[ $@ != *"nodist"* ]]; then
    ...
    java -jar ProjectBuilder.jar -os WINDOWS_NT -arch AMD64 -wi CHROMIUM_EMBEDDED_FRAMEWORK -v 1.2 -n "Casterlabs-Caffeinated" -jv JAVA11 -kv $KAIMEN_VERSION -res app/WMC-JsonConsoleWrapper.exe -cp app/Bootstrap/target/Caffeinated.jar -i icon.ico
    echo ""
