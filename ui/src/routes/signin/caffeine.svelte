...
<div class="mt-8 flex flex-col items-center">
	...
	<div class="mt-4 w-72">
		...
		<button
			type="button"
			class="relative w-full mt-1.5 cursor-pointer rounded-md py-1.5 px-2 transition-[background-color] bg-mauve-3 border border-mauve-6 hover:bg-mauve-5 hover:border-mauve-8 focus:border-crimson-7 focus:outline-none focus:ring-1 focus:ring-crimson-7 text-center text-xs"
			on:click={submit}
		>
			Sign In
		</button>
