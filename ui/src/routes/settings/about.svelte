...
<ul class="bg-mauve-2 shadow rounded-md border border-mauve-6 divide-y divide-current text-mauve-6">
	<li class="py-4 flex flex-row space-x-8">
		<div class="w-50 flex-1 flex items-center">
			...
			>
				...
				<g inkscape:groupmode="layer" id="layer1" inkscape:label="Dot" style="display:inline"
					><g id="g8">
						<path
							class="st0"
