...
{#if contextMenuOpen}
    <Portal target="#context-menu">
        <FocusListener on:lostfocus={() => (contextMenuOpen = false)} ignoreFocusState={true} class="absolute z-[45]" style="top: {contextMenuCoords[1]}px; left: {contextMenuCoords[0]}px;">
            <ul
