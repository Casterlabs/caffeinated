export default {
	...
	'sr.page.widgets.assign_tag': 'Tag',
	'sr.page.widgets.click_to_expand': 'Click to expand',
	'sr.page.widgets.click_to_shrink': 'Click to shrink',
	'sr.page.widgets.tag.none': '(None)',
	'sr.page.widgets.tag.red': 'Red',
	'sr.page.widgets.tag.green': 'Green',
	'sr.page.widgets.tag.blue': 'Blue',
