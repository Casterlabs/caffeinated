<script lang="ts">
	...
	import { render, renderStore, rerenderKey } from '$lib/locale/locale';
	...
	{#if true}
		...
		<form class="relative flex h-10 flex-row" autocomplete="off" onsubmit={submit}>
			...
			<div class="flex-1 relative">
				...
				<button class="absolute inset-y-2 right-2 flex items-center" onclick={() => uiEvents.broadcast('x-preferences-modal')} type="button" title={$lc_viewerPreferencesTitle}>
