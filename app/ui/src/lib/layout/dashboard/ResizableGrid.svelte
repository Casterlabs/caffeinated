...
<div class="relative w-full h-full">
	...
	<div class="fixed top-0 right-4 h-10 z-50 -translate-y-[2.25rem] hover:translate-y-0 px-2 transition-all rounded-b-md ring-1 ring-base-7 bg-base-5 text-base-12 opacity-90">
